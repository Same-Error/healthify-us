...
import 'package:healthy_recipies/modal/profile.modal.dart';
...
class _ProfileState extends State<Profile> {
  List<Orders> ofOrder = [Orders(name: "Your Orders"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("healthy recipies.in"),
        ...
        child: Column(
          ...
          children: [
            SizedBox(
              ...
              child: GridView.builder(itemCount: ofOrder.length,
